#!/usr/bin/env python3
"""
Resident OM inference worker for InternVL pipe mode.
...
def dry_run_outputs(worker: str, output_dir: Path) -> None:
    ...
    if worker == "vision":
        ...
        w("attention_mask_out.bin", MASK_BYTES)
